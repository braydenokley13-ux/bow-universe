    ...
    <div className="mx-auto max-w-5xl space-y-8 py-4">
      <div className="panel p-8">
        ...
        <p className="mt-4 max-w-3xl text-base leading-7 text-ink/72">
          Pick one league problem below. We will suggest the best lane for it, set up your first
          project, and save as you go.
        </p>
        {linkedTeamName ? (
          ...
          <aside className="rounded-[28px] border border-line bg-panel/85 p-6 shadow-panel">
            ...
            <div className="mt-6 rounded-2xl border border-line bg-white/70 p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-ink/68">
                We will open a beginner project with this issue already linked, the lane already
                chosen, and the questions broken into small steps.
              </p>
            </div>
            ...
            >
              {isPending ? "Starting..." : "Start this project"}
            </button>
          </aside>
        ) : null}
      </section>
